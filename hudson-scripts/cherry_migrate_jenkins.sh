...
python ./cm_tools/cherry_migrate.py --old-server android-cm-web.sonyericsson.net --new-server cmweb.sonyericsson.net --source ics-fuji --target edream6.1-fuji-release
python ./cm_tools/cherry_migrate.py --old-server android-cm-web.sonyericsson.net --new-server cmweb.sonyericsson.net --source ics-fuji --target edream6.1-fuji-r2-att-release
python ./cm_tools/cherry_migrate.py --old-server android-cm-web.sonyericsson.net --new-server cmweb.sonyericsson.net --source ics-fuji-kddi --target edream6.1-fuji-kddi-release
